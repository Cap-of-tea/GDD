  ...
  cat > "$WORK/manifest.json" <<EOF
{
  ...
  "description": "Browser automation MCP server with 38 tools: mobile device emulation, multi-player sessions, screenshots, DOM reading, network monitoring, and human-like input.",
  "author": {
    "name": "imVS",
