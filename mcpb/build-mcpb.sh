...
# Example: mcpb/build-mcpb.sh 1.8.0 artifacts Design/gdd-logo-400.png dist
  ...
  cat > "$WORK/manifest.json" <<EOF
{
  ...
  "description": "Browser automation MCP server with 39 tools: mobile device emulation, multi-player sessions, screenshots, DOM reading, network monitoring, and human-like input.",
  "author": {
    "name": "imVS",
