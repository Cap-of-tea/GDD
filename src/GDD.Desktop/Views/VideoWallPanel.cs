...
/// <summary>
/// Adaptive video-wall layout. Ported 1:1 from BrowserXn/Views/VideoWallPanel.cs
/// (WPF), with WPF types swapped for Avalonia. Algorithm unchanged: packs cells of
/// varying aspect ratio into rows or columns, choosing whichever maximises usage.
/// </summary>
public class VideoWallPanel : Panel
{
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            ars[i] = 0.46;
            if (elements[i] is Control fe && fe.DataContext is DesktopPlayerContext vm)
            {
    ...
    private void ArrangeGroups(Control[] elements, int[] order, double[] ars,
